...
WebUI.click(findTestObject('Object Repository/Page_Home Page/a_Add to Compare'))

WebUI.click(findTestObject('Object Repository/Page_Home Page/a_Add to Compare_1'))

WebUI.click(findTestObject('Object Repository/Page_Home Page/a_Compare Products        2 items'))
