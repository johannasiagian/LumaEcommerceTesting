...
WebUI.click(findTestObject('Object Repository/Page_Jackets - Tops - Women/div_Size'))

WebUI.click(findTestObject('Object Repository/Page_Jackets - Tops - Women/div_S'))

WebUI.click(findTestObject('Object Repository/Page_Jackets - Tops - Women/div_Style'))

WebUI.click(findTestObject('Object Repository/Page_Jackets - Tops - Women/a_Hooded                                   _2e13c4'))
