...
WebUI.click(findTestObject('Object Repository/Page_Home Page/a_My Cart                    1             _241c1f'))

WebUI.click(findTestObject('Object Repository/Page_Home Page/span_View and Edit Cart'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart/span_Move to Wishlist'))
