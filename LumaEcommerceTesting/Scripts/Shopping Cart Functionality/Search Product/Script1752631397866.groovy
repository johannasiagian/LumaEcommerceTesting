...
WebUI.setText(findTestObject('Object Repository/Page_Home Page/input_Search_q'), 'pants')

WebUI.click(findTestObject('Object Repository/Page_Home Page/li_pants for women25'))
