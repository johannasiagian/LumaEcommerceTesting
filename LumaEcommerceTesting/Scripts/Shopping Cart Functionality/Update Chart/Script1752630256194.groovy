...
WebUI.click(findTestObject('Object Repository/Page_Home Page/a_My Cart                    4             _2292c1'))

WebUI.click(findTestObject('Object Repository/Page_Home Page/span_View and Edit Cart'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart/a_Edit'))

WebUI.click(findTestObject('Object Repository/Page_Portia Capri/div_Color_option-label-color-93-item-53'))

WebUI.click(findTestObject('Object Repository/Page_Portia Capri/div_29'))

WebUI.click(findTestObject('Object Repository/Page_Portia Capri/button_Update Cart'))

WebUI.click(findTestObject('Object Repository/Page_Shopping Cart/button_Update Shopping Cart'))
